...
//        loadView("/views/event/event_list.fxml", "Gestion des événements");
//    }
//
//    public void goToAddEvent() {
//        System.out.println("Navigation vers Ajout d'événement");
//        loadView("/views/event/add_event.fxml", "Ajouter un événement");
//    }
//
...
//
//            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/event/add_event.fxml"));
//            Parent root = loader.load();
//
...
//            }
//
//            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/event/event_detail.fxml"));
//            Parent root = loader.load();
//
...
//
//            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/event/event_resource.fxml"));
//            Parent root = loader.load();
//
...
//            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/event/add_resource.fxml"));
//            Parent root = loader.load();
...
//
//            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/event/resource_detail.fxml"));
//            Parent root = loader.load();
//
...
//        loadView("/views/registration/registration_list.fxml", "Gestion des inscriptions");
//    }
//
...
//
//            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/registration/registration_detail.fxml"));
//
//            if (loader.getLocation() == null) {
...
//            System.out.println("ID inscription: " + registration.getId());
//
//            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/registration/edit_registration.fxml"));
//            Parent root = loader.load();
//
