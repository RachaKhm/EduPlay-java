...
public class CommandeService {
    ...
    public int ajouter(Commande c) {
        ...
        String parentCol = findExistingColumn("commande", "parent_id", "user_id");
    ...
    private Commande mapRow(ResultSet rs) throws SQLException {
        ...
        if (resultHasColumn(rs, "product_id")) c.setProductId(rs.getInt("product_id"));
        // Support both parent_id and user_id
        ...
        // created_at handled by DB; leave default or parse if needed
        return c;
    }
